#Usage: $ python predDTI_GPCR.py GPCR_Target.fasta Drug_selFV.csv > predDTI_GPCR.out
...
selDipep = ['LN', 'ED', 'DC', 'MH', 'GI', 'CL', 'VL', 'CT', 'CW', 'MY', 'VY']
...
RFpram = ['Fold1.csv', 'Fold2.csv', 'Fold3.csv', 'Fold4.csv', 'Fold6.csv']
